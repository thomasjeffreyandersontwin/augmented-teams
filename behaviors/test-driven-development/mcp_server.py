...
def get_project_root() -> Path:
    ...
    # MCP server is in behaviors/test-driven-development-mcp/
...
"""
        ...
        result += f"""
Feature directory: behaviors/{normalized_name}
State file: behaviors/{normalized_name}/.deployment-state.json
