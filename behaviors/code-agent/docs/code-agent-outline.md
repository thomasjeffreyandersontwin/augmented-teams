...
**Orchestrator:** Watcher processes managed via Task configs (`code-agent-tasks.json`) merged into `.vscode/tasks.json` - auto-start watchers on IDE launch using PID files in `.cursor/watchers/`.
