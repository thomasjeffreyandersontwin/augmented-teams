...
**Execution:**
* **Python Import** (Preferred): Import `{command_class_name}Command` from `{python_import}` and call:
  - Generate: `{command_class_name}Command().generate()`
  - Validate: `{command_class_name}Command().validate()`
  - Correct: `{command_class_name}Command().correct()`
* **CLI** (Fallback): 
  - Generate: `python {cli_runner} {generate_action} [command-parameters]`
  - Validate: `python {cli_runner} {validate_action} [command-parameters]`
  - Correct: `python {cli_runner} {correct_action} [command-parameters]`
...
2. **AI Agent** (using `{command_class_name}Command.generate()`) determines the [command-parameters] [parameter-list] (from user input or context)
...
2. **AI Agent** (using `{command_class_name}Command.validate()`) determines the [command-parameters] [parameter-list] (from user input or context)
