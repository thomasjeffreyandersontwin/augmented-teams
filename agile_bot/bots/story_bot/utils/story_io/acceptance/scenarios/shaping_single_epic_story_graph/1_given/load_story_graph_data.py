"""
Load story graph data for single epic story graph test.

GIVEN: Story graph with single epic
...
def get_story_graph() -> Dict[str, Any]:
    ...
    """
    story_graph_path = given_dir / "story-graph-single-epic.json"
...
def get_story_graph_path() -> Path:
    ...
    """
    return given_dir / "story-graph-single-epic.json"
