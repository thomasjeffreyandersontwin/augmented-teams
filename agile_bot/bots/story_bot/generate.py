#!/usr/bin/env python3
"""
Unified Generation Script for Story Bot

Generates all CLI and MCP server code for story_bot.
...
# generate.py is at agile_bot/bots/story_bot/generate.py
# Workspace root is 3 levels up: story_bot -> bots -> agile_bot -> workspace_root
...
# Bootstrap environment variables (same pattern as story_bot_cli.py)
...
def main():
    """Generate all CLI and MCP code for story_bot."""
    ...
    print("=" * 70)
    print("Story Bot Code Generation")
    print("=" * 70)
    ...
    print("  3. Use CLI commands via: story_bot --help")
