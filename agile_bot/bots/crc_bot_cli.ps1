# Crc Bot REPL CLI Launcher (Windows/PowerShell)
#
# Usage (for humans):
#   .\crc_bot_cli.ps1
#
# This launches the interactive REPL session for crc_bot
...
#     $env:BOT_DIRECTORY = "C:\dev\augmented-teams\agile_bot\bots\crc_bot"
...
$env:BOT_DIRECTORY = Join-Path $WORKSPACE_ROOT "agile_bot\bots\crc_bot"
