...
class Rule:
    ...
    def scan(self, knowledge_graph: Dict[str, Any], files: Optional[Dict[str, List[Path]]]=None, on_file_scanned: Optional[Any]=None, skip_cross_file: bool=False, changed_files: Optional[Dict[str, List[Path]]]=None) -> Dict[str, Any]:
        ...
        try:
            ...
            self._execute_cross_file_scan(scanner_instance, skip_cross_file, test_files, code_files, all_test_files, all_code_files)
    ...
    def _execute_cross_file_scan(self, scanner_instance, skip_cross_file, test_files, code_files, all_test_files, all_code_files):
        if not skip_cross_file and self.requires_two_pass_scan and hasattr(scanner_instance, 'scan_cross_file'):
            violations_cross_file = scanner_instance.scan_cross_file(rule_obj=self, test_files=test_files, code_files=code_files, all_test_files=all_test_files, all_code_files=all_code_files)
