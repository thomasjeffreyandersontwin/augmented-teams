...
class Rule:
    ...
    def scan(self, knowledge_graph: Dict[str, Any], files: Optional[Dict[str, List[Path]]]=None, on_file_scanned: Optional[Any]=None, skip_cross_file: bool=False) -> Dict[str, Any]:
        ...
        try:
            ...
            self._execute_cross_file_scan(scanner_instance, skip_cross_file, files, test_files, code_files)
    ...
    def _execute_cross_file_scan(self, scanner_instance, skip_cross_file, files, test_files, code_files):
        if not skip_cross_file and self.requires_two_pass_scan and files and hasattr(scanner_instance, 'scan_cross_file'):
            violations_cross_file = scanner_instance.scan_cross_file(rule_obj=self, test_files=test_files, code_files=code_files)
