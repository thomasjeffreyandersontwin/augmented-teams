...
class Actions:
    ...
    def close_current(self):
        ...
        self._mark_action_completed(state_data, current_action_obj)
    ...
    def _mark_action_completed(self, state_data, current_action_obj):
        ...
        action_state = f'{self.behavior.bot_name}.{self.behavior.name}.{current_action_obj.action_name}'
