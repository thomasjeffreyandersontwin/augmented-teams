...
class Strategy:
    ...
    def instructions(self) -> Dict[str, Any]:
        ...
        return {'strategy_criteria': strategy_criteria_dict, 'assumptions': self.assumptions.assumptions, 'recommended_activities': self.recommended_activities.recommended_activities}