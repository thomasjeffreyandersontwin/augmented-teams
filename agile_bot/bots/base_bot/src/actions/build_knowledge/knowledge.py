...
Aggregates KnowledgeGraphSpec and KnowledgeGraphTemplate for knowledge graph construction.
"""
...
class Knowledge:
    """Knowledge for building knowledge graphs.
    
    Domain Model:
        Properties: KnowledgeGraphSpec, KnowledgeGraphTemplate, Instructions
    """
    ...
    def instructions(self) -> Dict[str, Any]:
        """Get instructions dict with knowledge graph spec and template.
