"""Render configuration loader for RenderOutputAction."""
...
class RenderConfigLoader:
    """Handles loading render configurations, specs, instructions, and templates."""
    
    def __init__(self, behavior):
        """Initialize with behavior to access paths and bot_name."""
        self.behavior = behavior
    
    def find_render_folder(self) -> Path:
        """Find the render folder path."""
    ...
    def load_render_specs(self) -> List[RenderSpec]:
        """Load all render specs from render folder."""
        render_folder = self.find_render_folder()
        render_specs = []
    ...
    def load_render_configs(self) -> List[Dict[str, Any]]:
        """Load all render configs from render folder."""
        render_folder = self.find_render_folder()
        render_configs = []
    ...
    def load_single_render_config(self, render_json_file: Path) -> Dict[str, Any]:
        """Load a single render config file."""
    ...
    def verify_synchronizer_class(self, synchronizer_class_path: str) -> None:
        """Verify that synchronizer class exists and has required methods."""
