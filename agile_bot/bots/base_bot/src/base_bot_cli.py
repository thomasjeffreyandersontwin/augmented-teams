#!/usr/bin/env python3
"""
Base Bot CLI Entry Point

Command-line interface for base_bot using BaseBotCli.

Usage:
    base_bot [--behavior <name>] [--action <name>] [--options]
    base_bot --help
    base_bot --list
    base_bot --behavior <name> --list
    base_bot --close

Examples:
    base_bot
    base_bot --behavior exploration
    base_bot --behavior exploration --action clarify
    base_bot --behavior exploration --action clarify --increment_file=increment.txt
"""
