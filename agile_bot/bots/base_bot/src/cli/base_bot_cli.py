...
class BaseBotCli:
    ...
    def run(self, behavior_name: str=None, action_name: str=None, **kwargs) -> Dict[str, Any]:
        try:
            result = self.router.route_to_action(behavior_name, action_name, kwargs)
            return result
    ...
    def main(self):
        ...
        try:
            ...
            sys.exit(1)
        try:
            return self._dispatch_command(args, params)
    ...
    def _dispatch_command(self, args, params):
        if args.help:
        ...
        if args.list:
            ...
            return None
        return self.executor.execute_and_output(args, params)
