...
class TestCompleteWorkflowIntegration:
    ...
    def test_complete_workflow_end_to_end(self, tmp_path):
        ...
        # initialize_project auto-advances and returns the next action
        ...
        print("[OK] initialize_project completed, workflow advanced to gather_context")
        ...
        assert result.action == 'gather_context'  # Auto-advanced past initialize_project
        assert bot.shape.workflow.current_state == 'gather_context'
        print("[OK] forward_to_current_action auto-advanced and transitioned to gather_context")
