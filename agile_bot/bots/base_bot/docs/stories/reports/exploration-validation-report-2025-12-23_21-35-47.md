...
| 🟩 Clean Rules | 10 | No violations found |
...
- 🟨 **[Behavioral Ac At Story Level](#behavioral-ac-at-story-level)** - 15 violation(s) (EXECUTION_SUCCESS) - [View Details](#behavioral-ac-at-story-level-violations)
...
- 🟩 **[Present Ac Consolidation](#present-ac-consolidation)** - 0 violations (EXECUTION_SUCCESS)
  - Scanner: `agile_bot.bots.base_bot.src.scanners.ac_consolidation_scanner.ACConsolidationScanner`
...
### 🟩 Rule: <span id="present-ac-consolidation">Present Ac Consolidation</span> - CLEAN (0 violations)
...
### 🟨 Rule: <span id="behavioral-ac-at-story-level">Behavioral Ac At Story Level</span> - 15 VIOLATION(S) - [View Details](#behavioral-ac-at-story-level-violations)
...
#### <span id="behavioral-ac-at-story-level-violations">Behavioral Ac At Story Level: 15 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[0].story_groups[0].stories[0].name.acceptance_criteria[0]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[0].story_groups[0].stories[0].name.acceptance_criteria[0]): Acceptance criterion contains technical term "json" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[0].name.acceptance_criteria[1]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[0].name.acceptance_criteria[1]): Acceptance criterion contains technical term "class" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[0].name.acceptance_criteria[2]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[0].name.acceptance_criteria[2]): Acceptance criterion contains technical term "class" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[1].name.acceptance_criteria[2]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[1].name.acceptance_criteria[2]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[2].name.acceptance_criteria[1]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[2].story_groups[0].stories[2].name.acceptance_criteria[1]): Acceptance criterion contains technical term "class" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[1].name.acceptance_criteria[0]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[1].name.acceptance_criteria[0]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[1].name.acceptance_criteria[1]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[1].name.acceptance_criteria[1]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[1].name.acceptance_criteria[2]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[1].name.acceptance_criteria[2]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[2].name.acceptance_criteria[0]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[2].name.acceptance_criteria[0]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[2].name.acceptance_criteria[1]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[2].name.acceptance_criteria[1]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[3].name.acceptance_criteria[0]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[3].name.acceptance_criteria[0]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[4].name.acceptance_criteria[0]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[4].name.acceptance_criteria[0]): Acceptance criterion contains technical term "class" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[4].name.acceptance_criteria[2]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[4].name.acceptance_criteria[2]): Acceptance criterion contains technical term "config" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[5].name.acceptance_criteria[0]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[5].name.acceptance_criteria[0]): Acceptance criterion contains technical term "class" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[6].name.acceptance_criteria[0]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[6].name.acceptance_criteria[0]): Acceptance criterion contains technical term "class" - AC should describe behavioral outcomes, not technical implementation
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\exploration-validation-report-2025-12-23_21-35-47.md`
