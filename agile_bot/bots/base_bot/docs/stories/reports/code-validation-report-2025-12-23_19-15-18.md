...
Validated story map and domain model and 5 code file(s) against **32 validation rules**.
...
| 🟨 Rules with Warnings | 2 | Found 20 warning violation(s) |
| 🟥 Rules with Errors | 2 | Found 7 error violation(s) |
...
- 🟨 **[Chain Dependencies Properly](#chain-dependencies-properly)** - 19 violation(s) (EXECUTION_SUCCESS) - [View Details](#chain-dependencies-properly-violations)
...
- 🟨 **[Delegate To Lowest Level](#delegate-to-lowest-level)** - 6 violation(s) (EXECUTION_SUCCESS) - [View Details](#delegate-to-lowest-level-violations)
...
- 🟥 **[Place Imports At Top](#place-imports-at-top)** - 2 violation(s) (EXECUTION_SUCCESS) - [View Details](#place-imports-at-top-violations)
...
### 🟥 Rule: <span id="place-imports-at-top">Place Imports At Top</span> - 2 ERROR(S) - [View Details](#place-imports-at-top-violations)
...
### 🟨 Rule: <span id="chain-dependencies-properly">Chain Dependencies Properly</span> - 19 WARNING(S) - [View Details](#chain-dependencies-properly-violations)
...
#### <span id="chain-dependencies-properly-violations">Chain Dependencies Properly: 19 violation(s)</span>

- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:167): Passing self.current_behavior as parameter to _find_action(). Access it directly in the method through self.current_behavior instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:177): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:198): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:494): Passing self.current_behavior_name as parameter to _update_state_and_generate_response(). Access it directly in the method through self.current_behavior_name instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:512): Passing self.current_behavior_name as parameter to _render_action_parameters(). Access it directly in the method through self.current_behavior_name instead.
    ...
    ```python
        ...
        def _handle_help_command(self, args: str) -> REPLCommandResponse:
            args = args.strip()
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:560): Passing self.current_action_name as parameter to _execute_action_instructions(). Access it directly in the method through self.current_action_name instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:592): Passing self.current_action_name as parameter to _find_action_index(). Access it directly in the method through self.current_action_name instead.
    ...
    ```python
        ...
        def _handle_confirm_command(self) -> REPLCommandResponse:
            if not self.has_current_action:
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:592): Passing self.current_behavior_name as parameter to _error_behavior_not_found(). Access it directly in the method through self.current_behavior_name instead.
    ...
    ```python
        ...
        def _handle_confirm_command(self) -> REPLCommandResponse:
            if not self.has_current_action:
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:619): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:619): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```python
        ...
        def _advance_to_next_behavior(self) -> REPLCommandResponse:
            behavior_name = self.current_behavior_name
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:654): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:675): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:714): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:725): Passing self.current_action_name as parameter to _find_action_index(). Access it directly in the method through self.current_action_name instead.
    ...
    ```python
        ...
        def _handle_next_command(self) -> REPLCommandResponse:
            if not self.has_current_action:
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:725): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```python
        ...
        def _handle_next_command(self) -> REPLCommandResponse:
            if not self.has_current_action:
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:725): Passing self.current_behavior_name as parameter to _error_behavior_not_found(). Access it directly in the method through self.current_behavior_name instead.
    ...
    ```python
        ...
        def _handle_next_command(self) -> REPLCommandResponse:
            if not self.has_current_action:
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:757): Passing self.current_behavior_name as parameter to _find_behavior_index(). Access it directly in the method through self.current_behavior_name instead.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:757): Passing self.current_state as parameter to _save_state(). Access it directly in the method through self.current_state instead.
    ...
    ```python
        ...
        def _next_to_new_behavior(self) -> REPLCommandResponse:
            current_behavior_index = self._find_behavior_index(self.current_behavior_name)
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:945): Passing self.current_behavior_name as parameter to _navigate_to_action(). Access it directly in the method through self.current_behavior_name instead.
...
#### <span id="delegate-to-lowest-level-violations">Delegate To Lowest Level: 6 violation(s)</span>

- <span style="color: blue;">[i]</span> **INFO** - [`src\repl_cli\repl_help.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:37): Method "help_text" in Test class [ActionHelp](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:37) iterates through "_stages" instead of delegating to collection class. Delegate to collection class instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\repl_cli\repl_help.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:47): Method "help_text" in Test class [ActionHelp](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:47) iterates through "_context_parameters" instead of delegating to collection class. Delegate to collection class instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\repl_cli\repl_help.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:101): Method "actions_list" in Test class [BehaviorHelp](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:101) iterates through "action_names" instead of delegating to collection class. Delegate to collection class instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\repl_cli\repl_help.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:168): Method "main_help" in Test class [REPLHelp](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:168) iterates through "action_descriptions" instead of delegating to collection class. Delegate to collection class instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\repl_cli\repl_help.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:178): Method "main_help" in Test class [REPLHelp](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:178) iterates through "command_examples" instead of delegating to collection class. Delegate to collection class instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\repl_cli\repl_help.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:184): Method "main_help" in Test class [REPLHelp](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_help.py:184) iterates through "other_commands" instead of delegating to collection class. Delegate to collection class instead.

#### <span id="eliminate-duplication-violations">Eliminate Duplication: 5 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:189): Duplicate code blocks detected (3 locations) - extract to helper function.
  ...
  Location (_next_to_new_behavior:776-784):
    ...
    ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:190): Duplicate code blocks detected (2 locations) - extract to helper function.
  ...
  Location (_next_to_new_behavior:780-784):
    ...
    self.current_state['completed_...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:191): Duplicate code blocks detected (3 locations) - extract to helper function.
  ...
  Location (_next_to_new_behavior:781-786):
    ...
    ret...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:643): Duplicate code blocks detected (2 locations) - extract to helper function.
  ...
  Location (_next_to_new_behavior:776-786):
    ...
    ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:655): Duplicate code blocks detected (2 locations) - extract to helper function.
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:16): Class "REPLSession" is 936 lines - should be under 300 lines (extract related methods into separate classes)
...
#### <span id="place-imports-at-top-violations">Place Imports At Top: 2 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:12): Import statement found after non-import code. Move all imports to the top of the file.
    ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:13): Import statement found after non-import code. Move all imports to the top of the file.
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-23_19-15-18.md`
