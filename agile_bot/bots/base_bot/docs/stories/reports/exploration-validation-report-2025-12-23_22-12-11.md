...
- 🟨 **[Stories Developed And Tested In Days](#stories-developed-and-tested-in-days)** - 15 violation(s) (EXECUTION_SUCCESS) - [View Details](#stories-developed-and-tested-in-days-violations)
...
- 🟨 **[Behavioral Ac At Story Level](#behavioral-ac-at-story-level)** - 4 violation(s) (EXECUTION_SUCCESS) - [View Details](#behavioral-ac-at-story-level-violations)
...
### 🟨 Rule: <span id="behavioral-ac-at-story-level">Behavioral Ac At Story Level</span> - 4 VIOLATION(S) - [View Details](#behavioral-ac-at-story-level-violations)
...
### 🟨 Rule: <span id="stories-developed-and-tested-in-days">Stories Developed And Tested In Days</span> - 15 VIOLATION(S) - [View Details](#stories-developed-and-tested-in-days-violations)
...
#### <span id="behavioral-ac-at-story-level-violations">Behavioral Ac At Story Level: 4 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[0].name.acceptance_criteria[1]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[0].name.acceptance_criteria[1]): Acceptance criterion contains technical term "schema" - AC should describe behavioral outcomes, not technical implementation
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[0].name.acceptance_criteria[2]`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].sub_epics[3].story_groups[0].stories[0].name.acceptance_criteria[2]): Acceptance criterion contains technical term "parse" - AC should describe behavioral outcomes, not technical implementation
...
#### <span id="stories-developed-and-tested-in-days-violations">Stories Developed And Tested In Days: 15 violation(s)</span>
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\exploration-validation-report-2025-12-23_22-12-11.md`
