...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\headless\headless_config.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/headless/headless_config.py:38): Duplicate code blocks detected (2 locations) - extract to helper function.
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-29_17-52-52.md`
