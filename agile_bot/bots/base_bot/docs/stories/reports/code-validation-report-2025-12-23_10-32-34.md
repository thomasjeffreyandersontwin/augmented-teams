...
| 🟥 Rules with Errors | 1 | Found 3 error violation(s) |
...
- 🟥 **[Stop Writing Useless Comments](#stop-writing-useless-comments)** - 3 violation(s) (EXECUTION_SUCCESS) - [View Details](#stop-writing-useless-comments-violations)
...
### 🟥 Rule: <span id="stop-writing-useless-comments">Stop Writing Useless Comments</span> - 3 ERROR(S) - [View Details](#stop-writing-useless-comments-violations)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:14): Class "REPLSession" is 508 lines - should be under 300 lines (extract related methods into separate classes)
...
#### <span id="stop-writing-useless-comments-violations">Stop Writing Useless Comments: 3 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:321): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT

    ```python
        
        def _render_available_behaviors(self) -> str:
            """Render available behaviors from bot."""
            behavior_names = [b.name for b in self.bot.behaviors.behaviors_list]
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:326): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT

    ```python
        
        def _generate_behavior_help(self, behavior_name: str) -> str:
            """Render available actions for a behavior."""
            behavior = self._get_behavior(behavior_name)
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:335): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT

    ```python
        
        def _generate_action_help(self, behavior_name: str, action_name: str) -> str:
            """Render available parameters for an action based on its context class."""
            behavior = self._get_behavior(behavior_name)
    ```
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-23_10-32-34.md`
