...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/repl_session.py:43): Line 43: None check guard clause detected. Assume variables are initialized - let code fail fast if None.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/repl_session.py:423): Duplicate code blocks detected (2 locations) - extract to helper function.
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/repl_session.py:14): Class "REPLSession" is 504 lines - should be under 300 lines (extract related methods into separate classes)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/repl_session.py:106): Function "read_and_execute_command" is 47 lines - should be under 20 lines (extract complex logic to helper functions)
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/repl_session.py:157): Function "_handle_behavior_command" is 53 lines - consider improving vertical density by declaring variables near usage
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/repl_session.py:106): Function "read_and_execute_command" has nesting depth of 15 - use guard clauses and extract nested blocks to reduce nesting
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-23_10-28-32.md`
