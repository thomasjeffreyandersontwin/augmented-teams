...
[!] WARNING (line 93)
Line 93: Variable truthiness check detected (if changed:). Assume variable exists - let code fail fast if missing.
...
[!] WARNING (line 11)
Class "CodeScanner" is 465 lines - should be under 300 lines (extract related methods into separate classes)
...
[!] WARNING (line 40)
Class "DuplicationScanner" is 2052 lines - should be under 300 lines (extract related methods into separate classes)
...
[!] WARNING (line 11)
Class "GivenWhenThenHelpersScanner" is 389 lines - should be under 300 lines (extract related methods into separate classes)
...
[!] WARNING (line 16)
Class "Scanner" is 311 lines - should be under 300 lines (extract related methods into separate classes)
...
[!] WARNING (line 1821)
Function "scan_cross_file" is 235 lines - should be under 20 lines (extract complex logic to helper functions)
...
[!] WARNING (line 332)
Function "scan_cross_file" is 40 lines - should be under 20 lines (extract complex logic to helper functions)
...
[!] WARNING (line 33)
Function "scan_cross_file" is 45 lines - should be under 20 lines (extract complex logic to helper functions)
...
[i] INFO (line 87)
Function "_build_behavior_command_with_actions" is 59 lines - consider improving vertical density by declaring variables near usage
...
[i] INFO (line 1821)
Function "scan_cross_file" is 271 lines - consider improving vertical density by declaring variables near usage
...
[i] INFO (line 332)
Function "scan_cross_file" is 68 lines - consider improving vertical density by declaring variables near usage
...
[i] INFO (line 33)
Function "scan_cross_file" is 57 lines - consider improving vertical density by declaring variables near usage
...
[!] WARNING (line 379)
Line 379 uses numbered variable "start_line_0" - use meaningful descriptive name

[!] WARNING (line 383)
Line 383 uses numbered variable "end_line_0" - use meaningful descriptive name

[!] WARNING (line 386)
Line 386 uses numbered variable "end_line_0" - use meaningful descriptive name

[!] WARNING (line 392)
Line 392 uses numbered variable "start_line_0" - use meaningful descriptive name

[!] WARNING (line 394)
Line 394 uses numbered variable "end_line_0" - use meaningful descriptive name

[!] WARNING (line 396)
Line 396 uses numbered variable "end_line_0" - use meaningful descriptive name
...
[!] WARNING (line 1912)
Line 1912 contains magic number - replace with named constant

[!] WARNING (line 1914)
Line 1914 contains magic number - replace with named constant
...
[!] WARNING (line 1998)
Line 1998 uses numbered variable "block1" - use meaningful descriptive name
...
[!] WARNING (line 1999)
Line 1999 uses numbered variable "block2" - use meaningful descriptive name
...
[!] WARNING (line 2045)
Line 2045 uses numbered variable "file1" - use meaningful descriptive name

[!] WARNING (line 2046)
Line 2046 uses numbered variable "file2" - use meaningful descriptive name

[!] WARNING (line 2047)
Line 2047 uses numbered variable "func1" - use meaningful descriptive name

[!] WARNING (line 2048)
Line 2048 uses numbered variable "func2" - use meaningful descriptive name

[!] WARNING (line 2049)
Line 2049 uses numbered variable "start1" - use meaningful descriptive name

[!] WARNING (line 2050)
Line 2050 uses numbered variable "end1" - use meaningful descriptive name

[!] WARNING (line 2051)
Line 2051 uses numbered variable "start2" - use meaningful descriptive name

[!] WARNING (line 2052)
Line 2052 uses numbered variable "end2" - use meaningful descriptive name

[!] WARNING (line 2055)
Line 2055 uses numbered variable "preview1" - use meaningful descriptive name

[!] WARNING (line 2056)
Line 2056 uses numbered variable "preview2" - use meaningful descriptive name

[!] WARNING (line 2065)
Line 2065 uses numbered variable "location1" - use meaningful descriptive name

[!] WARNING (line 2066)
Line 2066 uses numbered variable "location2" - use meaningful descriptive name

[!] WARNING (line 510)
Line 510 uses numbered variable "block2" - use meaningful descriptive name

[!] WARNING (line 2060)
Line 2060 uses numbered variable "preview1" - use meaningful descriptive name

[!] WARNING (line 2062)
Line 2062 uses numbered variable "preview2" - use meaningful descriptive name
...
[X] ERROR (line 189)
Useless comment: "# Execute the help action" - delete it or improve the code instead
...
## stop_writing_useless_comments
**cli_parameter_parser.py** - 4 violation(s)
...
[!] WARNING (line 1821)
Function "scan_cross_file" has 6 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
...
[!] WARNING (line 158)
Function "_execute_cross_file_scan" has 7 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
...
Validation failed with error: Object of type Violation is not JSON serializable
