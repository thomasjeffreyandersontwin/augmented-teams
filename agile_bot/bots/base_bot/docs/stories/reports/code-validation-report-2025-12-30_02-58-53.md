...
| 🟨 Rules with Warnings | 6 | Found 12 warning violation(s) |
| 🟥 Rules with Errors | 3 | Found 48 error violation(s) |
...
- 🟨 **[Use Domain Language](#use-domain-language)** - 73 violation(s) (EXECUTION_SUCCESS) - [View Details](#use-domain-language-violations)
...
- 🟨 **[Simplify Control Flow](#simplify-control-flow)** - 5 violation(s) (EXECUTION_SUCCESS) - [View Details](#simplify-control-flow-violations)
...
### 🟨 Rule: <span id="simplify-control-flow">Simplify Control Flow</span> - 5 WARNING(S) - [View Details](#simplify-control-flow-violations)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1464): Line 1464: Variable truthiness check detected (if not args:). Assume variable exists - let code fail fast if missing.
...
#### <span id="simplify-control-flow-violations">Simplify Control Flow: 5 violation(s)</span>
...
#### <span id="use-domain-language-violations">Use Domain Language: 73 violation(s)</span>
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:924): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_prepare_headless_message (lines 924-930)):
    ```python
  ...
  Location 2 (repl_main.py:_execute_headless_with_context (lines 168-175)):
    ...
    if parsed[i].startswith('--'):
        ...
        i += 1
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1523): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_find_scope_matches (lines 1523-1528)):
    ```python
  ...
  Location 2 (action_context.py:_find_scope_matches_in_graph (lines 351-356)):
    ...
    if match_lines:
        ...
        lines.append(f'  - {scope_val} (no match)')
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1533): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_search_for_scope_match (lines 1533-1539)):
    ```python
  ...
  Location 2 (action_context.py:_search_for_scope_match (lines 362-368)):
    ...
    if match_lines:
        return match_lines
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1544): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_search_sub_epics (lines 1544-1550)):
    ```python
  ...
  Location 2 (action_context.py:_search_sub_epics (lines 374-380)):
    ...
    if match_lines:
        return match_lines
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1572): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_format_node_with_children (lines 1572-1586)):
    ```python
  ...
  Location 2 (action_context.py:_format_node_with_children (lines 413-427)):
    ...
    for story_group in node.get('story_groups', []):
        ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1573): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_format_node_with_children (lines 1573-1590)):
    ```python
    lines.append(f'{prefix}[{node_type}] {name}')
    if node_type == 'story':
        return lines
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1576): Duplicate code detected across files - extract to shared function.
  ...
  Location 1 (repl_session.py:_format_node_with_children (lines 1576-1592)):
    ```python
    if node_type == 'story':
        return lines
    for sub_epic in node.get('sub_epics', []):
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1572): Duplicate code detected across files - extract to shared function.
  ...
  Location 1 (repl_session.py:_format_node_with_children (lines 1572-1590)):
    ```python
    name = node.get('name', 'Unknown')
    lines.append(f'{prefix}[{node_type}] {name}')
    if node_type == 'story':
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1573): Duplicate code detected across files - extract to shared function.
  ...
  Location 1 (repl_session.py:_format_node_with_children (lines 1573-1592)):
    ```python
    lines.append(f'{prefix}[{node_type}] {name}')
    if node_type == 'story':
        return lines
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-30_02-58-53.md`
