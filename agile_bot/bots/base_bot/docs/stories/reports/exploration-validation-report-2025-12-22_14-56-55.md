...
- 🟨 **[Scenarios On Story Docs](#scenarios-on-story-docs)** - 15 violation(s) (EXECUTION_SUCCESS) - [View Details](#scenarios-on-story-docs-violations)
...
- 🟨 **[Map Sequential Spine Vs Optional Paths](#map-sequential-spine-vs-optional-paths)** - 3 violation(s) (EXECUTION_SUCCESS) - [View Details](#map-sequential-spine-vs-optional-paths-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.spine_optional_scanner.SpineOptionalScanner`
- 🟨 **[Stories Developed And Tested In Days](#stories-developed-and-tested-in-days)** - 1 violation(s) (EXECUTION_SUCCESS) - [View Details](#stories-developed-and-tested-in-days-violations)
...
### 🟨 Rule: <span id="map-sequential-spine-vs-optional-paths">Map Sequential Spine Vs Optional Paths</span> - 3 VIOLATION(S) - [View Details](#map-sequential-spine-vs-optional-paths-violations)
...
### 🟨 Rule: <span id="scenarios-on-story-docs">Scenarios On Story Docs</span> - 15 VIOLATION(S) - [View Details](#scenarios-on-story-docs-violations)
...
### 🟨 Rule: <span id="stories-developed-and-tested-in-days">Stories Developed And Tested In Days</span> - 1 VIOLATION(S) - [View Details](#stories-developed-and-tested-in-days-violations)
...
#### <span id="map-sequential-spine-vs-optional-paths-violations">Map Sequential Spine Vs Optional Paths: 3 violation(s)</span>
...
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[0].sequential_order`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[0].sequential_order): Story "Route to LangGraph Workflow" has sequential_order 8, but expected 1 (gap in sequence)
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements

#### <span id="scenarios-on-story-docs-violations">Scenarios On Story Docs: 15 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].story_groups[0].stories[0].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].story_groups[0].stories[0].name): Story "Generate Base Action Node" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].story_groups[0].stories[1].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].story_groups[0].stories[1].name): Story "Generate Behavior Graph Builder" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].story_groups[0].stories[2].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].story_groups[0].stories[2].name): Story "Generate LangGraph Runner" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].story_groups[0].stories[3].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].story_groups[0].stories[3].name): Story "Generate State Adapter" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[0].sub_epics[0].story_groups[0].stories[4].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[0].sub_epics[0].story_groups[0].stories[4].name): Story "Build Workflow Graph from Behavior" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[0].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[0].name): Story "Route to LangGraph Workflow" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[1].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[1].name): Story "Execute Workflow Nodes" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[2].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[2].name): Story "Manage Checkpoints" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[3].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[3].name): Story "Handle Execution Modes" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[4].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[4].name): Story "Collect Action Instructions" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[5].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[5].name): Story "Submit To AI and Continue" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[6].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[6].name): Story "Confirm AI Action Response" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[7].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[7].name): Story "Return to chat and pause for human-in-the-loop" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[8].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[8].name): Story "Return to Chat and Pause" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[9].name`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[9].name): Story "Resume Workflow from Checkpoint" has no scenarios or scenario_outlines in story-graph.json - scenarios should be in JSON (scenarios or scenario_outlines fields)

#### <span id="stories-developed-and-tested-in-days-violations">Stories Developed And Tested In Days: 1 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[0].story_groups[0].stories[3].acceptance_criteria`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/epics[1].sub_epics[0].story_groups[0].stories[3].acceptance_criteria): Story "Handle Execution Modes" has 13 13 acceptance criteria (should be 4-10)
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\exploration-validation-report-2025-12-22_14-56-55.md`
