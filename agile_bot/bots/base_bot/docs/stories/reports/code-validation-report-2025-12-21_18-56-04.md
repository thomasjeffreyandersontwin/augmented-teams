...
Validated story map and domain model and 9 code file(s) against **32 validation rules**.
...
| 🟨 Rules with Warnings | 6 | Found 6 warning violation(s) |
...
- 🟥 **[Use Resource Oriented Design](#use-resource-oriented-design)** - 2 violation(s) (EXECUTION_SUCCESS) - [View Details](#use-resource-oriented-design-violations)
...
### 🟥 Rule: <span id="use-resource-oriented-design">Use Resource Oriented Design</span> - 2 ERROR(S) - [View Details](#use-resource-oriented-design-violations)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\cli_executor.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_executor.py:73): Method "_output_result" in Test class [CliExecutor](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_executor.py:73) has Law of Demeter violation (method chain depth 3) - encapsulate access to related objects
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\business_readable_test_names_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/business_readable_test_names_scanner.py:107): Function "_check_business_readable" is 71 lines - consider improving vertical density by declaring variables near usage
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\behavior_matcher.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/behavior_matcher.py:86): Except block only contains pass at line 86 - exceptions must be logged or rethrown, never swallowed
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\business_readable_test_names_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/business_readable_test_names_scanner.py:16): Function "scan_file" has nesting depth of 4 - use guard clauses and extract nested blocks to reduce nesting
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\business_readable_test_names_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/business_readable_test_names_scanner.py:107): Function "_check_business_readable" has 6 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
...
#### <span id="use-resource-oriented-design-violations">Use Resource Oriented Design: 2 violation(s)</span>
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\cli_executor.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_executor.py:9): Class "CliExecutor" uses manager/doer/loader pattern but is not owned by a domain object. Use resource-oriented design instead (e.g., make it a property of a domain object like "Cli").
...
*... and 255 more instructions*

## Report Location

This report was automatically generated and saved to:
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-21_18-56-04.md`
