...
| 🟨 Rules with Warnings | 6 | Found 11 warning violation(s) |
| 🟥 Rules with Errors | 3 | Found 590 error violation(s) |
...
- 🟥 **[Eliminate Duplication](#eliminate-duplication)** - 557 violation(s) (EXECUTION_SUCCESS) - [View Details](#eliminate-duplication-violations)
  - Scanner: `agile_bot.bots.base_bot.src.scanners.duplication_scanner.DuplicationScanner`
- 🟥 **[Stop Writing Useless Comments](#stop-writing-useless-comments)** - 31 violation(s) (EXECUTION_SUCCESS) - [View Details](#stop-writing-useless-comments-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.scanners.useless_comments_scanner.UselessCommentsScanner`
- 🟨 **[Maintain Vertical Density](#maintain-vertical-density)** - 10 violation(s) (EXECUTION_SUCCESS) - [View Details](#maintain-vertical-density-violations)
...
### 🟥 Rule: <span id="eliminate-duplication">Eliminate Duplication</span> - 557 ERROR(S) - [View Details](#eliminate-duplication-violations)
...
### 🟥 Rule: <span id="stop-writing-useless-comments">Stop Writing Useless Comments</span> - 31 ERROR(S) - [View Details](#stop-writing-useless-comments-violations)
...
- **File-by-File Violations:** 56
- **Cross-File Violations:** 555
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1429): Line 1429: Variable truthiness check detected (if not args:). Assume variable exists - let code fail fast if missing.
...
#### <span id="maintain-vertical-density-violations">Maintain Vertical Density: 10 violation(s)</span>
...
#### <span id="stop-writing-useless-comments-violations">Stop Writing Useless Comments: 31 violation(s)</span>
...
#### <span id="eliminate-duplication-violations">Eliminate Duplication: 555 violation(s)</span>

- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:190): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (cursor_help_renderer_visitor.py:visit_behavior (lines 58-62)):
    ```python
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:190): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (cursor_help_renderer_visitor.py:visit_action (lines 76-80)):
    ```python
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:190): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 145-151)):
    ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:191): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:191): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 154-158)):
    ...
    lines.append('')
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:192): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:192): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 154-158)):
    ...
    lines.append('')
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:193): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:193): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 155-159)):
    ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:194): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:194): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 155-159)):
    ...
    lines.append(self.formatter.section_separator())
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:195): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:195): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 155-159)):
    ...
    lines.append(self.formatter.section_separator())
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:196): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:196): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 155-159)):
    ...
    lines.append(self.formatter.section_separator())
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:226): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:display_current_state (lines 226-232)):
    ```python
    lines.append(formatter.subsection_separator())
    lines.append(f'## {formatter.position_icon()} **Progress**')
    lines.append('**Current Position:**')
  ...
  Location 2 (cursor_help_renderer_visitor.py:visit_action (lines 77-81)):
    ```python
    self._add_line('')
    self._add_line(f'{context.action_description}')
    self._add_line('')
    ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:230): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:230): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 154-158)):
    ...
    lines.append('')
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:231): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:display_current_state (lines 231-237)):
    ```python
    lines.append('```')
    lines.append(f'{self.progress_path}.{self.stage_name}')
    lines.append('```')
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:226): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 147-154)):
    ...
    lines.append('// Run')
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:229): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:230): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 154-159)):
    ...
    lines.append(self.formatter.section_separator())
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:189): Duplicate code detected across files - extract to shared function.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:191): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (repl_status.py:hierarchical_status (lines 150-159)):
    ...
    ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:926): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_prepare_headless_message (lines 926-932)):
    ```python
  ...
  Location 2 (repl_main.py:_execute_headless_with_context (lines 168-175)):
    ...
    if parsed[i].startswith('--'):
        ...
        i += 1
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1488): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_find_scope_matches (lines 1488-1493)):
    ```python
  ...
  Location 2 (action_context.py:_find_scope_matches_in_graph (lines 357-362)):
    ...
    if match_lines:
        ...
        lines.append(f'  - {scope_val} (no match)')
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1498): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_search_for_scope_match (lines 1498-1504)):
    ```python
  ...
  Location 2 (action_context.py:_search_for_scope_match (lines 368-374)):
    ...
    if match_lines:
        return match_lines
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1509): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_search_sub_epics (lines 1509-1515)):
    ```python
  ...
  Location 2 (action_context.py:_search_sub_epics (lines 380-386)):
    ...
    if match_lines:
        return match_lines
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1537): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_format_node_with_children (lines 1537-1551)):
    ```python
  ...
  Location 2 (action_context.py:_format_node_with_children (lines 419-433)):
    ...
    for story_group in node.get('story_groups', []):
        ...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1538): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_format_node_with_children (lines 1538-1555)):
    ```python
    lines.append(f'{prefix}[{node_type}] {name}')
    if node_type == 'story':
        return lines
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1538): Duplicate code detected across files - extract to shared function.
  ...
  Location 2 (action_context.py:_format_node_with_children (lines 420-439)):
    ...
    for story_group in node.get('story_groups', []):
        for story in story_group.get('stories'...
    ```
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1541): Duplicate code detected across files - extract to shared function.

  Location 1 (repl_session.py:_format_node_with_children (lines 1541-1557)):
    ```python
    if node_type == 'story':
        return lines
    for sub_epic in node.get('sub_epics', []):
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1537): Duplicate code detected across files - extract to shared function.
  ...
  Location 1 (repl_session.py:_format_node_with_children (lines 1537-1555)):
    ```python
    name = node.get('name', 'Unknown')
    lines.append(f'{prefix}[{node_type}] {name}')
    if node_type == 'story':
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\repl_cli\repl_session.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/repl_cli/repl_session.py:1538): Duplicate code detected across files - extract to shared function.
  ...
  Location 1 (repl_session.py:_format_node_with_children (lines 1538-1557)):
    ```python
    lines.append(f'{prefix}[{node_type}] {name}')
    if node_type == 'story':
        return lines
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-30_02-36-00.md`
