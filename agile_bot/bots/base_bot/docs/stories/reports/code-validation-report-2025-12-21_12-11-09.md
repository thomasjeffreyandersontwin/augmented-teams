...
Validated story map and domain model and 223 code file(s) against **34 validation rules**.
...
| 🟨 Rules with Warnings | 13 | Found 417 warning violation(s) |
| 🟥 Rules with Errors | 5 | Found 673 error violation(s) |
| [i] No Scanner | 2 | Rule has no scanner configured |

**Total Rules:** 34
- **Rules with Scanners:** 32
  - 🟩 **Executed Successfully:** 32
- [i] **Rules without Scanners:** 2

### 🟩 Successfully Executed Scanners

- 🟥 **[Stop Writing Useless Comments](#stop-writing-useless-comments)** - 636 violation(s) (EXECUTION_SUCCESS) - [View Details](#stop-writing-useless-comments-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.scanners.useless_comments_scanner.UselessCommentsScanner`
- 🟨 **[Simplify Control Flow](#simplify-control-flow)** - 153 violation(s) (EXECUTION_SUCCESS) - [View Details](#simplify-control-flow-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.simplify_control_flow_scanner.SimplifyControlFlowScanner`
- 🟨 **[Provide Meaningful Context](#provide-meaningful-context)** - 105 violation(s) (EXECUTION_SUCCESS) - [View Details](#provide-meaningful-context-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.meaningful_context_scanner.MeaningfulContextScanner`
- 🟨 **[Maintain Vertical Density](#maintain-vertical-density)** - 58 violation(s) (EXECUTION_SUCCESS) - [View Details](#maintain-vertical-density-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.vertical_density_scanner.VerticalDensityScanner`
- 🟨 **[Use Clear Function Parameters](#use-clear-function-parameters)** - 54 violation(s) (EXECUTION_SUCCESS) - [View Details](#use-clear-function-parameters-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.clear_parameters_scanner.ClearParametersScanner`
- 🟨 **[Keep Functions Small Focused](#keep-functions-small-focused)** - 49 violation(s) (EXECUTION_SUCCESS) - [View Details](#keep-functions-small-focused-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.function_size_scanner.FunctionSizeScanner`
- 🟨 **[Avoid Excessive Guards](#avoid-excessive-guards)** - 16 violation(s) (EXECUTION_SUCCESS) - [View Details](#avoid-excessive-guards-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.excessive_guards_scanner.ExcessiveGuardsScanner`
- 🟥 **[Never Swallow Exceptions](#never-swallow-exceptions)** - 15 violation(s) (EXECUTION_SUCCESS) - [View Details](#never-swallow-exceptions-violations)
...
- 🟨 **[Hide Calculation Timing](#hide-calculation-timing)** - 2 violation(s) (EXECUTION_SUCCESS) - [View Details](#hide-calculation-timing-violations)
  - Scanner: `agile_bot.bots.base_bot.src.actions.validate.scanners.calculation_timing_code_scanner.CalculationTimingCodeScanner`
- 🟨 **[Use Domain Language](#use-domain-language)** - 2 violation(s) (EXECUTION_SUCCESS) - [View Details](#use-domain-language-violations)
...
### 🟥 Rule: <span id="stop-writing-useless-comments">Stop Writing Useless Comments</span> - 636 ERROR(S) - [View Details](#stop-writing-useless-comments-violations)
**Description:** CRITICAL: Most comments are useless. Kill AI-generated docstrings that just repeat function names and parameters. Only write comments for complex non-obvious algorithms, business rules, warnings, or legal notices. If the code is clear, NO COMMENT NEEDED.
**Scanner:** `agile_bot.bots.base_bot.src.actions.scanners.useless_comments_scanner.UselessCommentsScanner`
**Execution Status:** EXECUTION_SUCCESS

### 🟥 Rule: <span id="never-swallow-exceptions">Never Swallow Exceptions</span> - 15 ERROR(S) - [View Details](#never-swallow-exceptions-violations)
...
### 🟨 Rule: <span id="simplify-control-flow">Simplify Control Flow</span> - 153 WARNING(S) - [View Details](#simplify-control-flow-violations)
...
### 🟨 Rule: <span id="provide-meaningful-context">Provide Meaningful Context</span> - 105 WARNING(S) - [View Details](#provide-meaningful-context-violations)
...
### 🟨 Rule: <span id="use-clear-function-parameters">Use Clear Function Parameters</span> - 54 WARNING(S) - [View Details](#use-clear-function-parameters-violations)
...
### 🟨 Rule: <span id="keep-functions-small-focused">Keep Functions Small Focused</span> - 49 WARNING(S) - [View Details](#keep-functions-small-focused-violations)
...
### 🟨 Rule: <span id="avoid-excessive-guards">Avoid Excessive Guards</span> - 16 WARNING(S) - [View Details](#avoid-excessive-guards-violations)
...
### 🟨 Rule: <span id="use-domain-language">Use Domain Language</span> - 2 WARNING(S) - [View Details](#use-domain-language-violations)
...
**Total Violations:** 1165
- **File-by-File Violations:** 1165
...
#### <span id="avoid-excessive-guards-violations">Avoid Excessive Guards: 16 violation(s)</span>

- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\actions.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/actions.py:155): Line 155: None check guard clause detected. Assume variables are initialized - let code fail fast if None.
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:43): Line 43: Variable truthiness check detected (if has_scope_in_params:). Assume variable exists - let code fail fast if missing.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:97): Line 97: Variable truthiness check detected (if changed:). Assume variable exists - let code fail fast if missing.
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rule_loader.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rule_loader.py:22): Method "_load_rules_from_glob" in Test class [RuleLoader](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rule_loader.py:22) takes parameter "behavior" that is already injected in __init__. Use self.behavior instead.
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\actions\validate\validation_report_writer.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/validation_report_writer.py:145): Duplicate code blocks detected (2 locations) - extract to helper function.

  Location (_get_status_path:145-149):
    ```python
  ...
  Location (get_report_path:236-240):
    ```python
    docs_path = self.bot_paths.documentation_path
    docs_dir = self.workspace_directory / docs_path / 'reports'
    docs_dir.mkdir(parents=True, exist_ok=True)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\cli_executor.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_executor.py:102): Method "_output_result" in Test class [CliExecutor](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_executor.py:102) has Law of Demeter violation (method chain depth 3) - encapsulate access to related objects
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:11): Class "CodeScanner" is 465 lines - should be under 300 lines (extract related methods into separate classes)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:40): Class "DuplicationScanner" is 2052 lines - should be under 300 lines (extract related methods into separate classes)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/scanner.py:16): Class "Scanner" is 311 lines - should be under 300 lines (extract related methods into separate classes)
...
#### <span id="keep-functions-small-focused-violations">Keep Functions Small Focused: 49 violation(s)</span>

- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\base_bot_cli.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/base_bot_cli.py:163): Function "help_cursor_commands" is 28 lines - should be under 20 lines (extract complex logic to helper functions)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:52): Function "scan_file" is 67 lines - should be under 20 lines (extract complex logic to helper functions)
    ...
    ```python
        ...
        # ... (truncated)
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:1821): Function "scan_cross_file" is 235 lines - should be under 20 lines (extract complex logic to helper functions)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\given_state_not_actions_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/given_state_not_actions_scanner.py:16): Function "scan_story_node" has high cognitive complexity (20) - should be under 15. Reduce nesting and extract complex logic.
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\given_when_then_helpers_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/given_when_then_helpers_scanner.py:332): Function "scan_cross_file" is 40 lines - should be under 20 lines (extract complex logic to helper functions)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\property_encapsulation_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/property_encapsulation_scanner.py:35): Function "scan_domain_concept" is 33 lines - should be under 20 lines (extract complex logic to helper functions)
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\resource_oriented_code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/resource_oriented_code_scanner.py:33): Function "scan_cross_file" is 45 lines - should be under 20 lines (extract complex logic to helper functions)
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\vertical_slice_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/vertical_slice_scanner.py:22): Function "scan" is 26 lines - should be under 20 lines (extract complex logic to helper functions)
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\build\build_action.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/build/build_action.py:72): Function "inject_rules" is 33 lines - should be under 20 lines (extract complex logic to helper functions)
    ...
    ```
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:56): Function "get_last_report_timestamp" is 24 lines - should be under 20 lines (extract complex logic to helper functions)
...
#### <span id="maintain-vertical-density-violations">Maintain Vertical Density: 58 violation(s)</span>

- <span style="color: blue;">[i]</span> **INFO** - [`src\cli\cursor_command_generator.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cursor_command_generator.py:87): Function "_build_behavior_command_with_actions" is 59 lines - consider improving vertical density by declaring variables near usage
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:356): Function "_extract_code_snippet" is 56 lines - consider improving vertical density by declaring variables near usage
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:413): Function "_create_violation_with_snippet" is 63 lines - consider improving vertical density by declaring variables near usage
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:1821): Function "scan_cross_file" is 271 lines - consider improving vertical density by declaring variables near usage
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\given_when_then_helpers_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/given_when_then_helpers_scanner.py:332): Function "scan_cross_file" is 68 lines - consider improving vertical density by declaring variables near usage
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\resource_oriented_code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/resource_oriented_code_scanner.py:33): Function "scan_cross_file" is 57 lines - consider improving vertical density by declaring variables near usage
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\resource_oriented_code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/resource_oriented_code_scanner.py:114): Function "_class_uses_as_attribute" is 64 lines - consider improving vertical density by declaring variables near usage
...
#### <span id="never-swallow-exceptions-violations">Never Swallow Exceptions: 15 violation(s)</span>
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\cli_executor.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_executor.py:86): Except block only contains pass at line 86 - exceptions must be logged or rethrown, never swallowed
...
- <span style="color: red;">[X]</span> **ERROR** - `None`: Using .get() on _config attribute. Use object properties instead of accessing _config directly.
- <span style="color: red;">[X]</span> **ERROR** - `None`: Using .get() on _config attribute. Use object properties instead of accessing _config directly.
- <span style="color: red;">[X]</span> **ERROR** - `None`: Using .get() on _config attribute. Use object properties instead of accessing _config directly.
- <span style="color: red;">[X]</span> **ERROR** - `None`: Using .get() on _config attribute. Use object properties instead of accessing _config directly.
- <span style="color: red;">[X]</span> **ERROR** - `None`: Using .get() on _config attribute. Use object properties instead of accessing _config directly.
...
#### <span id="provide-meaningful-context-violations">Provide Meaningful Context: 105 violation(s)</span>
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:379): Line 379 uses numbered variable "start_line_0" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:383): Line 383 uses numbered variable "end_line_0" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:386): Line 386 uses numbered variable "end_line_0" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:392): Line 392 uses numbered variable "start_line_0" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:394): Line 394 uses numbered variable "end_line_0" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:396): Line 396 uses numbered variable "end_line_0" - use meaningful descriptive name
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:1912): Line 1912 contains magic number - replace with named constant
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:1914): Line 1914 contains magic number - replace with named constant
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:1998): Line 1998 uses numbered variable "block1" - use meaningful descriptive name
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:1999): Line 1999 uses numbered variable "block2" - use meaningful descriptive name
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2045): Line 2045 uses numbered variable "file1" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2046): Line 2046 uses numbered variable "file2" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2047): Line 2047 uses numbered variable "func1" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2048): Line 2048 uses numbered variable "func2" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2049): Line 2049 uses numbered variable "start1" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2050): Line 2050 uses numbered variable "end1" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2051): Line 2051 uses numbered variable "start2" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2052): Line 2052 uses numbered variable "end2" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2055): Line 2055 uses numbered variable "preview1" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2056): Line 2056 uses numbered variable "preview2" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2065): Line 2065 uses numbered variable "location1" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2066): Line 2066 uses numbered variable "location2" - use meaningful descriptive name
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2060): Line 2060 uses numbered variable "preview1" - use meaningful descriptive name
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2062): Line 2062 uses numbered variable "preview2" - use meaningful descriptive name
...
#### <span id="simplify-control-flow-violations">Simplify Control Flow: 153 violation(s)</span>
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\cli_executor.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_executor.py:62): Function "_output_result" has nesting depth of 4 - use guard clauses and extract nested blocks to reduce nesting
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\cli_parameter_parser.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_parameter_parser.py:231): Function "_parse_json_parameters" has nesting depth of 6 - use guard clauses and extract nested blocks to reduce nesting
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:356): Function "_extract_code_snippet" has nesting depth of 4 - use guard clauses and extract nested blocks to reduce nesting
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\resource_oriented_code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/resource_oriented_code_scanner.py:114): Function "_class_uses_as_attribute" has nesting depth of 10 - use guard clauses and extract nested blocks to reduce nesting
...
#### <span id="stop-writing-useless-comments-violations">Stop Writing Useless Comments: 636 violation(s)</span>
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\base_bot_cli.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/base_bot_cli.py:164): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\base_bot_cli.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/base_bot_cli.py:166): Useless comment: "# Create help action directly (doesn't need a behavior workf" - delete it or improve the code instead
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\base_bot_cli.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/base_bot_cli.py:176): Useless comment: "# Create a minimal behavior wrapper for the help action" - delete it or improve the code instead
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\base_bot_cli.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/base_bot_cli.py:189): Useless comment: "# Execute the help action" - delete it or improve the code instead
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\cli_parameter_parser.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_parameter_parser.py:88): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\cli_parameter_parser.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_parameter_parser.py:116): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\cli_parameter_parser.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_parameter_parser.py:232): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\cli_parameter_parser.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_parameter_parser.py:261): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\cli\cursor_command_generator.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cursor_command_generator.py:88): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:277): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:298): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2054): Useless comment: "# Get code snippets for both locations" - delete it or improve the code instead
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:2064): Useless comment: "# Create violation message with code boxes for each location" - delete it or improve the code instead
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\resource_oriented_code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/resource_oriented_code_scanner.py:115): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/scanner.py:135): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/scanner.py:222): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/scanner.py:236): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/scanner.py:248): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/scanner.py:260): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\test_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/test_scanner.py:101): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
- <span style="color: red;">[X]</span> **ERROR** - [`src\scanners\test_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/test_scanner.py:122): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\actions\validate\rule_loader.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rule_loader.py:82): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
- <span style="color: red;">[X]</span> **ERROR** - [`src\actions\validate\validation_report_writer.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/validation_report_writer.py:316): Useless docstring that repeats function/class name - delete it or explain WHY, not WHAT
...
#### <span id="use-clear-function-parameters-violations">Use Clear Function Parameters: 54 violation(s)</span>
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:356): Function "_extract_code_snippet" has 7 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:413): Function "_create_violation_with_snippet" has 12 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/duplication_scanner.py:1821): Function "scan_cross_file" has 6 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rule.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rule.py:113): Function "scan" has 6 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rule.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rule.py:146): Function "_execute_file_by_file_scan" has 6 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rule.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rule.py:158): Function "_execute_cross_file_scan" has 7 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:235): Function "_process_scanner_result" has 7 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:251): Function "_execute_scanner" has 12 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:271): Function "_process_rule" has 11 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:283): Function "validate" has 6 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
- <span style="color: orange;">[!]</span> **WARNING** - [`src\actions\validate\rules.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/actions/validate/rules.py:288): Function "_create_legacy_context" has 6 parameters - consider using existing domain objects with properties instead of passing primitives. Extend domain objects (Behaviors, Behavior, Actions, RenderSpec, etc.) with properties that encapsulate the needed data rather than creating new parameter objects.
...
#### <span id="use-domain-language-violations">Use Domain Language: 2 violation(s)</span>
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:379): Variable "start_line_0" uses technical notation. Use natural English instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:383): Variable "end_line_0" uses technical notation. Use natural English instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:386): Variable "end_line_0" uses technical notation. Use natural English instead.
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:403): Variable "end_line_0" uses technical notation. Use natural English instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:386): Variable "start_line_0" uses technical notation. Use natural English instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:394): Variable "end_line_0" uses technical notation. Use natural English instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:396): Variable "end_line_0" uses technical notation. Use natural English instead.
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:396): Variable "start_line_0" uses technical notation. Use natural English instead.
- <span style="color: blue;">[i]</span> **INFO** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/scanners/code_scanner.py:389): Variable "end_line_0" uses technical notation. Use natural English instead.
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-21_12-11-09.md`
