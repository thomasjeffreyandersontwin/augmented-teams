...
- <span style="color: orange;">[!]</span> **WARNING** - [`src\cli\cli_action_parsers.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_action_parsers.py:88): Line 88: None check guard clause detected. Assume variables are initialized - let code fail fast if None.
...
- <span style="color: blue;">[i]</span> **INFO** - [`src\cli\cli_action_parsers.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_action_parsers.py:75): Function "build_context_from_parsed" doesn't match domain terms. Use domain-specific language from specification: action, agent, behavior, bot, call, calls, catalog, class, classes, config...
- <span style="color: blue;">[i]</span> **INFO** - [`src\cli\cli_action_parsers.py`](vscode://file/C:/dev/augmented-teams/agile_bot/bots/base_bot/src/cli/cli_action_parsers.py:75): Function "build_context_from_parsed" uses parameter name "parsed_args" that doesn't match domain terms. Use domain-specific language: action, agent, behavior, bot, call, calls, catalog, class, classes, config...
...
`C:\dev\augmented-teams\agile_bot\bots\base_bot\docs\stories\reports\code-validation-report-2025-12-30_02-56-56.md`
