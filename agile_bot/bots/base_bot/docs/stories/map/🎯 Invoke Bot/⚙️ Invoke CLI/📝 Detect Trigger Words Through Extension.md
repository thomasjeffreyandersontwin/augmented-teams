...
Detect Trigger Words Through Extension functionality for the mob minion system.
...
### Scenario: Trigger bot only (no behavior or action specified) (happy_path)
...
### Scenario: Trigger bot and behavior (no action specified) (happy_path)
...
### Scenario: Trigger bot, behavior, and action explicitly (happy_path)
