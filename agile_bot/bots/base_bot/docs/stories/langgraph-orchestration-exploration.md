...
- BotMode: Determines node execution behavior (autonomous vs interactive), controls AI interaction pattern, and manages workflow pause points
...
- BotMode controls node behavior: Determines autonomous (direct AI calls) vs interactive (pause for human) execution
