"""
Load story graph data for simple story graph test.

GIVEN: Simple story graph with basic epic, feature, and story structure
...
def get_story_graph_path() -> Path:
    ...
    """
    return given_dir / "story-graph-simple.json"
