"""
Test render-sync-render round-trip for multiple_epics_features_test.
...
def main():
    ...
    print(f"\n{'='*80}")
    print("MULTIPLE EPICS FEATURES TEST ROUND-TRIP TEST")
    print(f"{'='*80}")
    
    # Step 1: Given - verify input data exists
    print("\nGIVEN: Verify input data exists...")
    given_dir = test_dir / "1_given"
    story_graph_path = given_dir / "story-graph-multiple-epics-features.json"
