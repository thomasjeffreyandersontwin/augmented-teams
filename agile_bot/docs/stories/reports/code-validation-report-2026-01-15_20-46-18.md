...
- 🟨 **[Detect Legacy Unused Code](#detect-legacy-unused-code)** - 6 violation(s) (EXECUTION_SUCCESS) - [View Details](#detect-legacy-unused-code-violations)
...
### 🟨 Rule: <span id="detect-legacy-unused-code">Detect Legacy Unused Code</span> - 6 WARNING(S) - [View Details](#detect-legacy-unused-code-violations)
...
#### <span id="detect-legacy-unused-code-violations">Detect Legacy Unused Code: 6 violation(s)</span>

- <span style="color: orange;">[!]</span> **WARNING** - [`src\bot\behaviors.py`](vscode://file/C:/dev/augmented-teams/agile_bot/src/bot/behaviors.py:251): Unused function '_is_final_behavior' - consider removing dead code
- <span style="color: orange;">[!]</span> **WARNING** - [`src\behaviors\behaviors.py`](vscode://file/C:/dev/augmented-teams/agile_bot/src/behaviors/behaviors.py:259): Unused function '_is_final_behavior' - consider removing dead code
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/src/scanners/code_scanner.py:190): Unused function '_parse_code_file' - consider removing dead code
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\code_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/src/scanners/code_scanner.py:190): Unused function '_parse_code_file' - consider removing dead code
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/src/scanners/duplication_scanner.py:1400): Unused function '_get_node_signature' - consider removing dead code
- <span style="color: orange;">[!]</span> **WARNING** - [`src\scanners\duplication_scanner.py`](vscode://file/C:/dev/augmented-teams/agile_bot/src/scanners/duplication_scanner.py:1400): Unused function '_get_node_signature' - consider removing dead code
...
`C:\dev\augmented-teams\agile_bot\docs\stories\reports\code-validation-report-2026-01-15_20-46-18.md`
