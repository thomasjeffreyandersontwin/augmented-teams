...
- 🟨 **[Small And Testable](#small-and-testable)** - 12 violation(s) (EXECUTION_SUCCESS) - [View Details](#small-and-testable-violations)
...
- 🟥 **[Verb Noun Format](#verb-noun-format)** - LOAD FAILED
  ...
  - Error: `Error loading scanner agile_bot.bots.base_bot.src.scanners.verb_noun_scanner.VerbNounScanner: expected an indented block after 'try' statement on line 20 (vocabulary_helper.py, line 21)`
- 🟥 **[Active Business And Behavioral Language](#active-business-and-behavioral-language)** - LOAD FAILED
  ...
  - Error: `Error loading scanner agile_bot.bots.base_bot.src.scanners.active_language_scanner.ActiveLanguageScanner: expected an indented block after 'try' statement on line 20 (vocabulary_helper.py, line 21)`
...
### 🟨 Rule: <span id="small-and-testable">Small And Testable</span> - 12 VIOLATION(S) - [View Details](#small-and-testable-violations)
...
#### <span id="small-and-testable-violations">Small And Testable: 12 violation(s)</span>
...
- <span style="color: red;">[X]</span> **ERROR** - [`Create Scope`](vscode://file/C:/dev/augmented-teams/agile_bot/Create%20Scope): Story "Create Scope" appears to be an implementation operation - should be a step within a story that describes user/system outcome
- <span style="color: red;">[X]</span> **ERROR** - [`Save Guardrails`](vscode://file/C:/dev/augmented-teams/agile_bot/Save%20Guardrails): Story "Save Guardrails" appears to be an implementation operation - should be a step within a story that describes user/system outcome
- <span style="color: red;">[X]</span> **ERROR** - [`Save Guardrails Through Panel`](vscode://file/C:/dev/augmented-teams/agile_bot/Save%20Guardrails%20Through%20Panel): Story "Save Guardrails Through Panel" appears to be an implementation operation - should be a step within a story that describes user/system outcome
- <span style="color: red;">[X]</span> **ERROR** - [`Save Guardrails Through CLI`](vscode://file/C:/dev/augmented-teams/agile_bot/Save%20Guardrails%20Through%20CLI): Story "Save Guardrails Through CLI" appears to be an implementation operation - should be a step within a story that describes user/system outcome
...
`C:\dev\augmented-teams\agile_bot\docs\stories\reports\shape-validation-report-2026-01-15_18-26-45.md`
