...
- 🟨 **[Map Sequential Spine Vs Optional Paths](#map-sequential-spine-vs-optional-paths)** - 31 violation(s) (EXECUTION_SUCCESS) - [View Details](#map-sequential-spine-vs-optional-paths-violations)
...
### 🟨 Rule: <span id="map-sequential-spine-vs-optional-paths">Map Sequential Spine Vs Optional Paths</span> - 31 VIOLATION(S) - [View Details](#map-sequential-spine-vs-optional-paths-violations)
...
#### <span id="map-sequential-spine-vs-optional-paths-violations">Map Sequential Spine Vs Optional Paths: 31 violation(s)</span>
...
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[1].sub_epics[0].story_groups[0].stories[6].sequential_order`](vscode://file/C:/dev/augmented-teams/agile_bot/epics%5B1%5D.sub_epics%5B1%5D.sub_epics%5B0%5D.story_groups%5B0%5D.stories%5B6%5D.sequential_order): Story "Execute End To End Workflow" has sequential_order 999, but expected 7 (gap in sequence)
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[1].sub_epics[1].story_groups[0].stories[0].sequential_order`](vscode://file/C:/dev/augmented-teams/agile_bot/epics%5B1%5D.sub_epics%5B1%5D.sub_epics%5B1%5D.story_groups%5B0%5D.stories%5B0%5D.sequential_order): Story "Create Scope" has sequential_order 999, but expected 1 (gap in sequence)
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[1].sub_epics[2].story_groups[0].stories[0].sequential_order`](vscode://file/C:/dev/augmented-teams/agile_bot/epics%5B1%5D.sub_epics%5B1%5D.sub_epics%5B2%5D.story_groups%5B0%5D.stories%5B0%5D.sequential_order): Story "Build Story Graph" has sequential_order 999, but expected 1 (gap in sequence)
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
...
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
- <span style="color: red;">[X]</span> **ERROR** - [`epics[1].sub_epics[5].story_groups[0].stories[2].sequential_order`](vscode://file/C:/dev/augmented-teams/agile_bot/epics%5B1%5D.sub_epics%5B5%5D.story_groups%5B0%5D.stories%5B2%5D.sequential_order): Story "Resolve Bot Path" has sequential_order 4, but expected 3 (gap in sequence)
- <span style="color: orange;">[!]</span> **WARNING** - ``: All stories in story group have sequential_order - consider marking some as optional if they are alternatives or enhancements
...
`C:\dev\augmented-teams\agile_bot\docs\stories\reports\prioritization-validation-report-2026-01-14_23-12-14.md`
