...
1. **Extract the release** to your project:
   ```bash
   unzip code-agent-v1.0.zip -d your-project/
   cd your-project
   ```
...
features/code-agent-behavior/              # The behavior management system
  ...
  ├── code-agent-index.json      # Local behavior catalog
  ├── code-agent-outline.md      # Feature overview
...
python commands/code-agent-structure-cmd.py validate

# Fix structure issues
python commands/code-agent-structure-cmd.py fix

# Create new behavior
python commands/code-agent-structure-cmd.py create <feature> <behavior-name>
```

### Sync Commands
```bash
# Sync all behaviors
python commands/code-agent-sync-cmd.py

# Sync specific feature
python commands/code-agent-sync-cmd.py <feature-name>

# Watch mode (auto-sync on changes)
python commands/code-agent-sync-cmd.py watch
```
