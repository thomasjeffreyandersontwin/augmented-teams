# story_bot_shape - Navigate to Shape Behavior

## Navigate to Behavior
$env:BOT_DIRECTORY = 'C:\dev\augmented-teams\agile_bot\bots\story_bot'; $env:PYTHONPATH = 'C:\dev\augmented-teams'; echo 'shape' | python agile_bot/bots/base_bot/src/repl_cli/repl_main.py

## Navigate to Specific Action
$env:BOT_DIRECTORY = 'C:\dev\augmented-teams\agile_bot\bots\story_bot'; $env:PYTHONPATH = 'C:\dev\augmented-teams'; echo 'shape.${1|rules|clarify|strategy|build|validate|render|}' | python agile_bot/bots/base_bot/src/repl_cli/repl_main.py
