...
**Context for Discovery**: When proceeding to Discovery phase, reference the same source material (Hero's Handbook PDF) and sections to elaborate stories. Focus particularly on:
- Point cost calculations and formulas
- Power Level limits and trade-off rules
- Prerequisite requirements for advantages and powers
- Equipment point system and catalog
- Validation rules for character legality
