...
### 🟨 Rule: <span id="map-sequential-spine-vs-optional-paths">Map Sequential Spine Vs Optional Paths</span> - 10 VIOLATION(S) - [View Details](#map-sequential-spine-vs-optional-paths-violations)
...
`C:\dev\augmented-teams\demo\mob_minion\docs\stories\reports\prioritization-validation-report-2026-01-04_12-54-23.md`
