...
- <span style="color: red;">[X]</span> **ERROR** - [`Set Target`](vscode://file//mnt/c/dev/augmented-teams/demo/mob_minion/Set Target): Story "Set Target" appears to be an implementation operation - should be a step within a story that describes user/system outcome
- <span style="color: red;">[X]</span> **ERROR** - [`Apply Strategy Criteria`](vscode://file//mnt/c/dev/augmented-teams/demo/mob_minion/Apply Strategy Criteria): Story "Apply Strategy Criteria" appears to be an implementation operation - should be a step within a story that describes user/system outcome
...
`/mnt/c/dev/augmented-teams/demo/mob_minion/docs/stories/reports/shape-validation-report-2025-12-30_14-00-13.md`
