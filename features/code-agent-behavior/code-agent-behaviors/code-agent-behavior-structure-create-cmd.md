...
**Example:**
```bash
python code-agent-behavior-structure-cmd.py create code-agent-behavior test-behavior
```
Creates:
* `code-agent-behavior-test-behavior-rule.mdc`
* `code-agent-behavior-test-behavior-cmd.md`
* `code-agent-behavior-test-behavior-cmd.py`
...
**File Location:**
* All files created in `features/<feature>/cursor/` (organized in Behavior Features - collections of tightly-knit, strongly related behaviors)
